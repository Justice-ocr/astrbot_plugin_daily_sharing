...
const settingsFieldSchema = {
  ...
  cfgImageProvider: { section: "image_conf", field: "image_provider" },
  cfgGenericImagePlugin: { section: "image_conf", field: "generic_image_plugin_name" },
  cfgGenericImageMethod: { section: "image_conf", field: "generic_image_method_path" },
  cfgGenericImagePromptArg: { section: "image_conf", field: "generic_image_prompt_arg" },
  cfgGenericImageExtraArgs: { section: "image_conf", field: "generic_image_extra_args" },
  cfgGenericImageResultField: { section: "image_conf", field: "generic_image_result_field" },
  cfgGenericImageEditMethod: { section: "image_conf", field: "generic_image_edit_method_path" },
  cfgGenericImageEditPromptArg: { section: "image_conf", field: "generic_image_edit_prompt_arg" },
  cfgGenericImageEditExtraArgs: { section: "image_conf", field: "generic_image_edit_extra_args" },
  cfgGenericImageRefKeys: { section: "image_conf", field: "generic_image_ref_keys" },
  ...
  cfgVideoProvider: { section: "image_conf", field: "video_provider" },
  cfgGenericVideoPlugin: { section: "image_conf", field: "generic_video_plugin_name" },
  cfgGenericVideoMethod: { section: "image_conf", field: "generic_video_method_path" },
  cfgGenericVideoExtraArgs: { section: "image_conf", field: "generic_video_extra_args" },
  cfgGenericVideoResultField: { section: "image_conf", field: "generic_video_result_field" },
  ...
  cfgTtsProvider: { section: "tts_conf", field: "tts_provider" },
  cfgGenericTtsPlugin: { section: "tts_conf", field: "generic_tts_plugin_name" },
  cfgGenericTtsMethod: { section: "tts_conf", field: "generic_tts_method_path" },
  cfgGenericTtsTextArg: { section: "tts_conf", field: "generic_tts_text_arg" },
  cfgGenericTtsExtraArgs: { section: "tts_conf", field: "generic_tts_extra_args" },
  cfgGenericTtsResultField: { section: "tts_conf", field: "generic_tts_result_field" },
